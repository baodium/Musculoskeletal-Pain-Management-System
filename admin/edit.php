...
if(!isset($_GET['id']) || !($disorder=$handle->getDisorder($_GET['id'])) ){
...
<div class="main" style="">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Edit Muskuloskeletal Pain</span><span style="float:right"><input type="button" name="register"  style="float:right; cursor:pointer" value="Add New MP" id="button" onClick="loadUrl('new.php');" class="send" /></span></h2>
          <div class="clr"></div>
          ...
          <fieldset style="border-radius:5px; border:1px solid #999999"><br/>
            <ol style="padding-left:60px">
              <li>
                ...
                <input id="name" name="name" class="text" value="<?php echo $disorder[0]['name']; ?>  " />
              </li>
              <li>
              ...
              <li>
               ...
               <?php if($disorder[0]['description']!=NULL){echo $disorder[0]['description']; } ?>                      
                </textarea>
              </li>
              <li>
                <label for="symptoms">Symptoms</label>
               <textarea  name="" rows="3">
               <?php if($disorder[0]['symptoms']!=NULL){echo $disorder[0]['symptoms']; } ?>                     
                </textarea>
              </li>
              <li>
                <label for="treatment">Treatment</label>
               <textarea  name="" rows="3">   
               <?php if($disorder[0]['treatment']!=NULL){echo $disorder[0]['treatment']; } ?>                    
                </textarea>
              </li>
              <li>
                <label for="recommendation">Recommendation</label>
                <textarea  name="recommend" rows="3"> 
                <?php if($disorder[0]['recommendation']!=NULL){echo $disorder[0]['recommendation']; } ?>                  
                </textarea>      
              </li>
